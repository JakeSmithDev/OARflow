...
import { acceptEstimate, convertToInvoice } from '../lib/estimates.js';
...
router.get('/:id', asyncHandler(async (req, res) => {
  ...
  res.json({
    ...
    estimate: {
      ...
      notes: e.notes, terms: e.terms, validUntil: e.valid_until, acceptedAt: e.accepted_at, acceptedName: e.accepted_name,
    },
